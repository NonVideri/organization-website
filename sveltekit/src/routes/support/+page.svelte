<script lang="ts">
	...
	const DESCRIPTION =
		"Help support the mission of the Thriving Individuals Foundation. Learn about ways you can contribute and make a difference.";
...
<Section class="py-2 md:py-4 xl:py-6" isVisible>
	<SubscribeForm />
</Section>
